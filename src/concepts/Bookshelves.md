...
----
TODO: 
- [ ] generate book and/or docs for each repo and publish to a GitHub release page.
- [ ] hopefully the release page will have a $LATEST type of functionality so we can have a consistent link to docs within the release for external referencing.
- [ ] create bookshelf index pages for each shelf
- [ ] create a library page that lists the book shelves
